...
- **目标用户**：企业员工（B2B2C）
- **产品形态**：独立 Web 应用
- **权威设计文档**：@docs/design/product-plan-v2.1.md
...
- `docs/plans/`
  ...
  - 这里不是权威产品设计，不应和 `product-plan-v2.1.md` 并列为真相源
- `specs/`
...
- 若 `plans/` 与 `design/` 内容冲突，以 `docs/design/product-plan-v2.1.md` 为准，再回头修正 `plans/`
...
- 如果新增的是长期有效的架构规则，必须先更新 `docs/design/product-plan-v2.1.md` 或对应 `design` 文档
...
├── docs/
│   ├── design/                         ← 设计文档与参考文献整理
│   │   └── product-plan-v2.1.md          ← 产品方案（权威设计文档）
│   └── reference/                      ← 参考文献 PDF
├── specs/                              ← Planner 输出
...
详见 @docs/design/product-plan-v2.1.md 第 4-7 节。
...
- @docs/design/product-plan-v2.1.md — 产品方案 v2.1（权威，当前版本）
